...
When a user sends a PDF via Slack or WhatsApp, it is automatically saved to the `attachments/` directory. The message will include a path hint like:

> [File: document.pdf (application/pdf)] saved to attachments/document.pdf
